...
export default function AppWidgetSummary({ title, active, inactive, total }) {
  return (
    <Card sx={{ display: 'flex', alignItems: 'center', p: 3 }}>
      <Box sx={{ flexGrow: 1 }}>
        <Typography variant="subtitle2">{title}</Typography>

        <Stack direction="row" alignItems="center" justifyContent='space-between' spacing={1} sx={{ mt: 2, mb: 1 }}>
          {/* <IconWrapperStyle
            sx={{
              ...(percent < 0 && {
                color: 'error.main',
