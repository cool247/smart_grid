...
import chart from '/smart-grid-chart-.avif';
import meter from '/smart-meter.jpg';
    ...
    <RootStyle>
      <Container component={MotionViewport} sx={{ position: 'relative', textAlign: 'center' }}>
        ...
        <m.div variants={varFade().inUp}>
          ...
          >
            Revolutionize Your Energy Future: Embark on a Sustainable Journey with Minteck's Smart Grid Solution.
          </Typography>
        </m.div>
        ...
        <Box sx={{ position: 'relative',  }}>
          <Image alt="grid" src={chart} />

          {/* <Box sx={{ position: 'absolute', top: 0 }}>
            <m.div variants={varFade().inUp}>
              <Image disabledEffect alt="screen" src={meter} />
            </m.div>
          </Box> */}
          ...
          {/* <Box sx={{ position: 'absolute', top: 0 }}>
            <m.div variants={varFade().inDown}>
              <m.div animate={{ y: [0, -15, 0] }} transition={{ duration: 8, repeat: Infinity }}>
                <Image disabledEffect alt="sidebar" src={solar} />
              </m.div>
            </m.div>
          </Box> */}
